...
func (s *Server) maintenance(ctx context.Context, tenantID string) maintenanceNotice {
...
func (s *Server) refuseIfReadOnly(w http.ResponseWriter, r *http.Request, tenantID string) bool {
	switch r.Method {
...
// remember to poll.
func (s *Server) notices(ctx context.Context, tenantID string) []Notice {
