...
func (s *Server) handleCredentialRedeem(w http.ResponseWriter, r *http.Request) {
...
// with.
func (s *Server) handleImpersonationRedeem(w http.ResponseWriter, r *http.Request) {
	r.Body = http.MaxBytesReader(w, r.Body, maxRecoveryBody)
	var req struct {
		Token string `json:"token"`
	}
...
func (s *Server) endImpersonations(ctx context.Context) {
