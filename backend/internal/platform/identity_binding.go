...
func (s *Server) startIdentityBinding(ctx context.Context, issuer string, identity *ssoclient.Identity) (string, error) {
	buf := make([]byte, 32)
...
func (s *Server) loadBinding(ctx context.Context, token string) (*pendingBinding, error) {
...
func (s *Server) handleBindingSession(w http.ResponseWriter, r *http.Request) {
...
func (s *Server) bindingProviderName(issuer string) string {
...
func (s *Server) handleBindingConsent(w http.ResponseWriter, r *http.Request) {
	var req struct {
...
func (s *Server) handleBindingEIDStart(w http.ResponseWriter, r *http.Request) {
	var req struct {
		Binding    string `json:"binding"`
...
func (s *Server) handleBindingEIDPoll(w http.ResponseWriter, r *http.Request) {
	var req struct {
		Binding   string `json:"binding"`
...
func (s *Server) sweepExpiredBindings(ctx context.Context) {
	if _, err := s.db.Exec(ctx,
