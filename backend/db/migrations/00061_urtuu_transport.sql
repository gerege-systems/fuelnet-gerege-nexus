...
CREATE TABLE IF NOT EXISTS urtuu_peers (
    ...
    -- Энэ холбоосыг АЛЬ суулгацын түлхүүрээр байгуулсан бэ (нийтийн
    -- түлхүүрээс гаралтай ID). Нэг өгөгдлийн санд нэг суулгац байдаг тул
    -- энэ утга бодит ажиллагаанд тогтмол — гэхдээ тогтмол гэдэг нь бичих
    -- шаардлагагүй гэсэн үг биш:
    --   * URTUU_SIGNING_KEY солигдвол хуучин түлхүүрээр байгуулагдсан
    --     холбоосууд ажиллахаа болино. Энэ багана байхгүй бол тэдгээр нь
    --     чимээгүй унтарна; байвал аль нь болохыг нэрлэж чадна;
    --   * холбоос бүрийн token нь тэр түлхүүрээс гаралтай тул "энэ
    --     холбоосыг би төлөөлж чадах уу" гэсэн асуултад хариулах цорын ганц
    --     зам нь энэ.
...
-- Тээврийн давталтын query: "би доод тал байх, идэвхтэй, өөрийн түлхүүрээр
-- байгуулагдсан холбоосууд".
