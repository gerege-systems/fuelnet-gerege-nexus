...
> **Түүхэн design record — хэрэгжсэн.** Энэ саналын A–G үе шат 2026-08-24-нд
> `main`-д орсон. Доорх “юуг харсан” хэсгийн файл, route, role-ын тоонууд нь
> refactor-ын **өмнөх snapshot**; одоогийн contract-ыг
> [архитектурын тодорхойлолт](ARCHITECTURE_SPECIFICATION.md),
> [хэрэгжилтийн шалгалт](TWO_PLANES_REVIEW.md),
> [control-plane runbook](CONTROL_PLANE.md)-аас харна уу.
...
Огноо: 2026-08-24 · Статус: хэрэгжсэн түүхэн санал · Хамрах хүрээ: `backend/`

---

## 1. Юуг харсан бэ — хэрэгжүүлэхийн өмнөх review
