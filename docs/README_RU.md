...
| --- | --- | --- | --- | --- |
| 1 | Организация и сотрудники | `io.gerege.nexus.core` | `/organisation` | Юридические данные организации, её подразделения и сотрудники — базовое приложение, отключить нельзя |
