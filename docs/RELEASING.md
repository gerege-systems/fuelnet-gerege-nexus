...
болгож, юугаар солихыг нь заана; CHANGELOG-ийн "Deprecated" хэсэгт бичнэ;
...
`PlatformVersion` нь өөр зүйл: тэр нь **manifest-ийн шаардлагыг** шалгах
хувилбар (`"platform": ">=1.1.0"`). Хоёулаа нэг тоо байх ёстой бөгөөд
build нь `-ldflags`-аар tag-аас нь дамжуулж стампдана — эс тэгвээс образ бүр
өөрийгөө 1.0.0 гэж стор бүрд хэлнэ.
