# Control Panel — операторын консолын төлөвлөгөө

**cp.nexus.gerege.mn** дээр ажиллах платформ операторын консол (control
plane) — дэлхийн туршлагын судалгаа ба бүрэн feature төлөвлөгөө.
...
консол — cp.nexus.gerege.mn) гэж ялгадаг. Control Panel нь энэ хоёр дахь нь.
