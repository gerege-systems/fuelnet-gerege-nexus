...
1. ~~`gerege-appstore`~~ → **[appstore-gerege-nexus](https://github.com/gerege-systems/appstore-gerege-nexus)**
   ...
   хэрэгтэй;
2. `gerege-gov` — дараагийн тод vertical. Хамгийн цэвэр нь: `00006_gov_services.sql`,
   `00007_gov_workflow.sql` хоёр нь зөвхөн `gov_*` хүснэгт үүсгэдэг, өөр домэйн
   тэдгээрийн дотор байхгүй;
3. `gerege-commerce` — сүүлд, гэхдээ **энд өмнө нь бичсэн шалтгаан буруу байсан**.
   "contacts/products-ийн FK хамаарлыг SDK interface-ээр цэвэрлэх" гэж бичигдсэн
   боловч 2026-08-15-ны хэмжилтээр тийм хамаарал байхгүй нь тогтоогдов: апп
   модулиуд хооронд Go import **огт байхгүй**; commerce-ээс `contacts` руу FK
   байхгүй (`billing_invoices` нь `contact_name VARCHAR` буюу denormalized
   утга хадгалдаг); commerce-ийн хүснэгтүүд рүү гаднаас заасан FK ч байхгүй.

   Жинхэнэ саад нь **миграцын түүхийн орооцолдоон**: `00003_business_apps.sql`
   нэг файлдаа `contacts` (цөмд үлдэх) болон `products`/`warehouses`/
   `stock_levels`/`stock_movements` (явах) хоёуланг үүсгэдэг; `billing_invoices`
   нь `00004`-т `sessions`, `oauth` зэрэг платформын хүснэгттэй хамт байна.
   Хэрэглэгдсэн миграцыг буцаан бичих боломжгүй тул шилжилт нь: цөм тэдгээр
   хүснэгтийг **шинэ суулгацад үүсгэхээ болих**, distribution нь өөрийн
   түүхээрээ (`MIGRATIONS_DIR`/`MIGRATIONS_TABLE`) `IF NOT EXISTS`-ээр эзэмших,
   аль хэдийн ажиллаж буй суулгацын өгөгдөл хөндөгдөхгүй байх — гурвуулаа нэг
   зэрэг биелэх ёстой.

   Мөн бүтээгдэхүүний шийдвэр дагалдана: nexus.gerege.mn дээр эдгээр аппын
   бодит өгөгдөл байгаа тул модулиуд цөмөөс гарахад тэр суулгац commerce
   distribution-ыг мөн байршуулахгүй бол аппуудаа алдана;
