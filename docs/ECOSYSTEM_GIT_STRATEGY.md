...
| ~~**`contacts`**~~ → `organisation`-д нэгдэв (2026-08-15) | `apps/contacts` | Хоёр карт нэг сэдвийг хоёр хуваасан байв: энэ байгууллага хэнээс бүрддэг, хэнтэй харьцдаг вэ. Пакет үлдсэн — модуль биш, `organisation`-ий дотоод бүртгэл; эрх `organisation.read/manage` болов (миграц 00059). ХУР авто-бөглөлт нь `egov`-ийн үйлчилгээг дууддаг хэвээр. Олон модулийн FK суурь тул цөмд (Odoo-гийн base/contacts статус) |
