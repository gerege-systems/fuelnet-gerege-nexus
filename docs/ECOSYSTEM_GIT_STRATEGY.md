...
2. ~~`gerege-gov`~~ → **[gov-gerege-nexus](https://github.com/gerege-systems/gov-gerege-nexus)**
   ...
   **Салгалт гурван үе шаттай явна, production алхам бүр дээр бүтэн үлдэнэ:**
   ...
   (2) nexus.gerege.mn-ийг цөм+модулийн композицийн образаар байршуулж
   батлах; (3) дараа нь л цөмөөс модулийг хасах. Хасалт нь эхний алхам байвал
   батлагдаагүй зүйлийн төлөө production эрсдэлд орно.

   2-р үе шатанд модуль хоёр газраас бүртгэгдэнэ — цөмийн `apps.Bootstrap`
   болон композицийн `Modules` функцээс. `nexus.Register` нь ID-гаар нь
   сүүлчийнхийг үлдээдэг тул distribution-ы хуулбар үйлчилнэ. Энэ давхардал
   нь эвдрэл биш, харин яг шалгамаар зүйлийг шалгах боломж: композиц баригдаж,
   образ асч, платформ гаднаас бүртгэгдсэн модультай ажиллаж байна уу. Тэр нь
   батлагдсаны дараа 3-р үе шат нь жижиг өөрчлөлт болно.
