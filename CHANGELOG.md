...
### Note —  таван метод авсан нь v1 доторх шийдвэр

 §1 нь экспортолсон interface-д метод нэмэхийг эвдэх өөрчлөлт
гэж нэрлэдэг: гаднаас түүнийг хэрэгжүүлж байсан бүх төрөл компиллогдохоо
болино. Энэ хувилбар -д таван метод нэмж байгаа тул журмаараа
major байх ёстой.

Minor-оор гаргаж байгаа шалтгаан, ил тод:  бол платформ **өгдөг**
...
-ийг өөрөө хэрэгжүүлдэг бол энэ хувилбар дээр компайл
