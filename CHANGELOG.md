...
`cp.nexus.gerege.mn/cp` нь «This page couldn't load» гэж унадаг байв. Шалтгаан
нь хоёр мөрөнд байсан: `observability.New(...)` нь `Warnings` callback-ыг огт
дамжуулаагүй тул `warnings` талбар JSON-д `null` болж, консолын нүүр хуудас
түүнийг `.map` хийхэд бүх дэлгэц унана. Go-д nil slice нь `null` болдог бөгөөд
жагсаалт гэж зарласан талбар `null` ирэх нь «богино жагсаалт» биш, өөр төрөл.
...
жагсаалт болгодог болов — найман талбарыг найман газарт санахын оронд нэг
дор. Тест нь тэглэсэн `Overview` дээр `null` талбар байхгүйг шалгана.
