...
`urtuu` нь энэ жагсаалтад **байхгүй**, учир нь түүний production код
`internal/`-аас юу ч импортлодоггүй — энэ ажлын гол шагнал түүнд аль
хэдийн олдсон. Шалтгаан ба хойшлуулалтыг өөрчлөх шалгуур
`docs/adr/0001-domain-first.md`-д.
