...
const dictionary = {
  ...
  // ─── State services workflow ───────────────────────────────────────────────
  "gov.subtitle": { mn: "Үйлчилгээний паспорт, хүсэлт, шилжүүлэлт ба баталгаажуулалт", en: "Service passports, requests, delegation and verification" },
  "gov.refresh": { mn: "Шинэчлэх", en: "Refresh" },
  "gov.tab.queue": { mn: "Дараалал", en: "Queue" },
  "gov.tab.configuration": { mn: "Тохиргоо", en: "Configuration" },
  "gov.card.received": { mn: "Хүлээн авсан", en: "Received" },
  "gov.card.inProgress": { mn: "Хийгдэж буй", en: "In progress" },
  "gov.card.delegated": { mn: "Шилжүүлсэн", en: "Delegated" },
  "gov.card.awaitingVerification": { mn: "Баталгаажуулалт хүлээж буй", en: "Awaiting verification" },
  "gov.card.returned": { mn: "Буцаагдсан", en: "Returned" },
  "gov.card.completed": { mn: "Гүйцэтгэсэн", en: "Fulfilled" },
  "gov.card.overdue": { mn: "Хугацаа хэтэрсэн", en: "Overdue" },
  "gov.filter.allStatuses": { mn: "Бүх төлөв", en: "All statuses" },
  "gov.filter.allUnits": { mn: "Бүх нэгж", en: "All units" },
  "gov.filter.overdueOnly": { mn: "Зөвхөн хугацаа хэтэрсэн", en: "Overdue only" },
  "gov.unit": { mn: "Нэгж", en: "Unit" },
  "gov.due": { mn: "Хугацаа", en: "Due" },
  "gov.overdue": { mn: "хэтэрсэн", en: "overdue" },
  "gov.mode": { mn: "Гүйцэтгэх хэлбэр", en: "Fulfilment mode" },
  "gov.currentUnit": { mn: "Хариуцаж буй нэгж", en: "Responsible unit" },
  "gov.tasks": { mn: "Даалгаврууд", en: "Tasks" },
  "gov.commentPrompt": { mn: "Тайлбар бичнэ үү", en: "Enter a comment" },
  "gov.delegateTo": { mn: "Аль нэгж рүү шилжүүлэх вэ?", en: "Which unit should this go to?" },
  "gov.noChildUnit": { mn: "Шилжүүлэх доод нэгж алга.", en: "There is no lower unit to delegate to." },
  "gov.previous": { mn: "Өмнөх", en: "Previous" },
  "gov.next": { mn: "Дараах", en: "Next" },
  "gov.pageOf": { mn: "{page} / {total} хуудас", en: "Page {page} of {total}" },
  ...
  "gov.status.RECEIVED": { mn: "Хүлээн авсан", en: "Received" },
  "gov.status.ASSIGNED": { mn: "Хуваарилсан", en: "Assigned" },
  "gov.status.IN_PROGRESS": { mn: "Хийгдэж буй", en: "In progress" },
  "gov.status.FORWARDED": { mn: "Шилжүүлсэн", en: "Forwarded" },
  "gov.status.INFO_REQUESTED": { mn: "Мэдээлэл хүлээж буй", en: "Info requested" },
  "gov.status.COMPLETED": { mn: "Гүйцэтгэсэн", en: "Completed" },
  "gov.status.AWAITING_VERIFICATION": { mn: "Баталгаажуулалт хүлээж буй", en: "Awaiting verification" },
  "gov.status.RETURNED": { mn: "Буцаагдсан", en: "Returned" },
  "gov.status.REJECTED": { mn: "Татгалзсан", en: "Rejected" },
  "gov.status.CLOSED": { mn: "Хаагдсан", en: "Closed" },
  "gov.status.CANCELLED": { mn: "Цуцлагдсан", en: "Cancelled" },
  "gov.config.units": { mn: "Байгууллагын бүтэц", en: "Organisational units" },
  "gov.config.noUnits": { mn: "Нэгж бүртгэгдээгүй байна.", en: "No units yet." },
  "gov.config.unitCode": { mn: "Код", en: "Code" },
  "gov.config.unitName": { mn: "Нэр", en: "Name" },
  "gov.config.noParent": { mn: "Дээд нэгжгүй", en: "No parent" },
  "gov.config.workflows": { mn: "Ажлын урсгал", en: "Workflows" },
  "gov.config.noWorkflows": { mn: "Урсгал үүсгээгүй байна.", en: "No workflows yet." },
  "gov.config.pickTemplate": { mn: "Загвар сонгох", en: "Pick a template" },
  "gov.config.publish": { mn: "Үүсгээд нийтлэх", en: "Create and publish" },
  "gov.config.services": { mn: "Үйлчилгээний тохиргоо", en: "Service configuration" },
  "gov.config.workflowVersion": { mn: "Урсгалын хувилбар", en: "Workflow version" },
  "gov.config.ownerUnit": { mn: "Хариуцах нэгж", en: "Owning unit" },
  // ─── State services (base) ─────────────────────────────────────────────────
  "gov.loading": { mn: "Ачаалж байна...", en: "Loading..." },
  "gov.noServices": { mn: "Үйлчилгээ бүртгэгдээгүй байна.", en: "No services registered yet." },
  "gov.queueEmpty": { mn: "Дараалалд ажил алга.", en: "Nothing in the queue." },
  "gov.reference": { mn: "Дугаар", en: "Reference" },
  "gov.service": { mn: "Үйлчилгээ", en: "Service" },
  "gov.timeline": { mn: "Явц", en: "Timeline" },
  "gov.title": { mn: "Төрийн үйлчилгээ", en: "State services" },
  // ─── State services screens ────────────────────────────────────────────────
  "gov.menu.requests": { mn: "Үйлчилгээний хүсэлт", en: "Service requests" },
  "gov.menu.requestsHint": { mn: "Шат бүрийн дараалал, шилжүүлэлт ба баталгаажуулалт", en: "The queue every level works from: delegation and verification" },
  "gov.menu.appointments": { mn: "Цаг захиалга", en: "Appointments" },
  "gov.menu.appointmentsHint": { mn: "Иргэдийн ирэх цагийн захиалга", en: "In-person visit slots booked by citizens" },
  "gov.menu.catalog": { mn: "Үйлчилгээний каталог", en: "Service catalog" },
  "gov.menu.catalogHint": { mn: "Үйлчилгээний паспорт, гүйцэтгэх хэлбэр ба урсгалын тохиргоо", en: "Service passports, fulfilment mode and workflow configuration" },
  "gov.menu.workflow": { mn: "Шийдвэрлэх урсгал", en: "Decision workflow" },
  "gov.menu.workflowHint": { mn: "Байгууллагын бүтэц, урсгалын хувилбар ба чиглүүлэлтийн дүрэм", en: "Organisational units, workflow versions and routing rules" },
  "gov.menu.sla": { mn: "Үйлчилгээний түвшин", en: "Service levels" },
  "gov.menu.slaHint": { mn: "Шат бүрийн хугацааны стандарт ба хэтэрсэн ажлын хяналт", en: "Per-step time standards and overdue monitoring" },
  "gov.overview": { mn: "Тойм", en: "Overview" },
  "gov.overviewHint": { mn: "Төрийн үйлчилгээний ерөнхий байдал ба шуурхай холбоос", en: "Where the app stands, and where to go next" },
  "gov.open": { mn: "Нээх", en: "Open" },
  "gov.appointment.new": { mn: "Шинэ цаг захиалах", en: "Book an appointment" },
  "gov.appointment.citizen": { mn: "Иргэн", en: "Citizen" },
  "gov.appointment.when": { mn: "Хэзээ", en: "When" },
  "gov.appointment.location": { mn: "Байршил", en: "Location" },
  "gov.appointment.none": { mn: "Захиалсан цаг алга.", en: "No appointments booked." },
  "gov.appointment.book": { mn: "Захиалах", en: "Book" },
  "gov.sla.step": { mn: "Шат", en: "Step" },
  "gov.sla.hours": { mn: "Хугацаа (цаг)", en: "SLA (hours)" },
  "gov.sla.verification": { mn: "Баталгаажуулалт шаардана", en: "Requires verification" },
  "gov.sla.overdueTasks": { mn: "Хугацаа хэтэрсэн ажил", en: "Overdue work" },
  "gov.sla.noWorkflow": { mn: "Нийтэлсэн урсгал алга — эхлээд Шийдвэрлэх урсгал хэсгээс үүсгэнэ үү.", en: "No published workflow yet — create one under Decision workflow." },
  "gov.routing.title": { mn: "Чиглүүлэлтийн дүрэм", en: "Routing rules" },
  "gov.routing.none": { mn: "Дүрэм үүсгээгүй байна.", en: "No routing rules yet." },
  "gov.routing.strategy": { mn: "Стратеги", en: "Strategy" },
  "gov.routing.priority": { mn: "Урьтамж", en: "Priority" },
  "gov.routing.match": { mn: "Тохирол", en: "Match" },
  "gov.routing.target": { mn: "Зорилтот нэгж", en: "Target unit" },
  "gov.routing.add": { mn: "Дүрэм нэмэх", en: "Add rule" },
  "gov.yes": { mn: "Тийм", en: "Yes" },
  "gov.no": { mn: "Үгүй", en: "No" },
