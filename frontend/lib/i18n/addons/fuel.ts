...
export const fuel = {
  ...
  "fuel.station.add": { mn: "ШТС нэмэх", en: "Add a station" },
  "fuel.station.edit": { mn: "Засах", en: "Edit" },
  "fuel.station.delete": { mn: "Устгах", en: "Delete" },
  "fuel.station.delete_confirm": {
  ...
  "fuel.station.name": { mn: "Нэр", en: "Name" },
  "fuel.station.brand": { mn: "Брэнд", en: "Brand" },
  "fuel.station.aimag": { mn: "Аймаг, хот", en: "Province or city" },
  "fuel.station.district": { mn: "Сум, дүүрэг", en: "District" },
  "fuel.station.address": { mn: "Хаяг", en: "Address" },
  "fuel.station.phone": { mn: "Утас", en: "Telephone" },
  "fuel.station.hours": { mn: "Ажиллах цаг", en: "Opening hours" },
  "fuel.station.lat": { mn: "Өргөрөг", en: "Latitude" },
  "fuel.station.lon": { mn: "Уртраг", en: "Longitude" },
  "fuel.station.coords_hint": {
  ...
  "fuel.station.pumps": { mn: "Түгээгүүр", en: "Pumps" },
  "fuel.station.active_pumps": { mn: "Ажиллаж буй", en: "In service" },
  "fuel.station.voucher": { mn: "Ваучер хүлээж авна", en: "Accepts vouchers" },
  "fuel.station.status": { mn: "Төлөв", en: "Status" },
  "fuel.station.price": { mn: "Үнэ (₮)", en: "Price (₮)" },
  "fuel.station.capacity": { mn: "Савны багтаамж (л)", en: "Tank capacity (l)" },
  "fuel.station.stock_note": {
  ...
  "fuel.station.grade_status.available": { mn: "Байгаа", en: "Available" },
  "fuel.station.grade_status.low": { mn: "Дуусаж байна", en: "Running low" },
  "fuel.station.grade_status.out": { mn: "Дууссан", en: "Out" },
  "fuel.station.status.available": { mn: "Ажиллаж байна", en: "Open" },
  "fuel.station.status.closed": { mn: "Хаалттай", en: "Closed" },
  "fuel.station.reported": { mn: "Мэдээлсэн", en: "Reported" },
  "fuel.station.never_reported": { mn: "Хэзээ ч мэдээлээгүй", en: "Never reported" },
  "fuel.station.search": { mn: "ШТС хайх", en: "Search stations" },
  "fuel.station.save": { mn: "Хадгалах", en: "Save" },
  "fuel.station.cancel": { mn: "Болих", en: "Cancel" },
